...
class PPO(object):
    ...
    def __init__(self):
        ...
        self.model_path='./models/test/test'
    ...
    def save_model(self):
        ...
        """
        with self.graph.as_default():
            last_checkpoint = self.model_path+'/model-test.cptk'
...
def trainPP0():
    try:
        ...
        for ep in range(EP_MAX):
            ...
            #--------------------------#
            s = env.reset(train_mode=True)[default_brain].vector_observations
            #--------------------------#
            ...
            for t in range(EP_LEN):    # in one episode
                ...
                s_=env_info.vector_observations
